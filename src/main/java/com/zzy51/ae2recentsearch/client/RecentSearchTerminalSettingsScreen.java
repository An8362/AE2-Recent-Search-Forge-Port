...
public final class RecentSearchTerminalSettingsScreen<C extends MEStorageMenu>
    ...
    private Button deleteButtonsButton;
    private Button favoritesButton;
    private Button keyboardNavigationButton;
    private Button mouseScrollButton;
    private Button favoriteDragButton;
    private Button applyOnClickButton;
    private Button syncExternalSearchButton;
    ...
    public RecentSearchTerminalSettingsScreen(TerminalSettingsScreen<C> parent) {
        ...
        hideTerminalSlots();
        widgets.add("back", new TabButton(menu.getHost().getMainMenuIcon(),
